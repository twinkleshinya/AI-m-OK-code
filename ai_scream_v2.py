...
摘要生成: Ollama 本地模型 (Qwen 3 14B)，完全免费。
"""
...
def strip_think_tags(text):
    """移除 Qwen 3 思考模式产生的 <think>...</think> 标签及其内容。"""
...
{news_list}"""
    ...
    try:
        ...
        # Qwen 3 默认开启思考模式，需要清理 <think>...</think> 标签
...
def main():
    ...
    # 3. Ollama 生成中文标题与摘要
    print(f"\n[4/5] Generating Chinese summaries with Ollama ({OLLAMA_MODEL})...")
